...
const validarAtributosProducto = (method) => [
    ...
    body("descuentoUno").notEmpty().withMessage("El primer descuento no puede estar vacío").bail().isFloat().withMessage("El primer descuento debe ser un valor numerico"),
    body("descuentoDos").notEmpty().withMessage("El segundo descuento no puede estar vacío").bail().isFloat().withMessage("El segundo descuento debe ser un valor numerico"),
